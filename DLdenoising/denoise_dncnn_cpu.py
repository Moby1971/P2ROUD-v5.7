...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='dncnn3', help='dncnn_15, dncnn_25, dncnn_50, dncnn_gray_blind, dncnn3')
    parser.add_argument('--testset_name', type=str, default='inputImages', help='test set')
