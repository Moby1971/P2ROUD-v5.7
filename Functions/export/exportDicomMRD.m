...
% ---------------------
    ...
    function dicomHeader = generateDicomheaderMRD(fname,fileCounter,i,j,k,z)
        ...
        dcmHead.ImagePositionPatient = [-obj.FOV/2 -(obj.aspectratio*obj.FOV/2) (z-round(obj.NO_SLICES_DCM/2))*(obj.SLICE_SEPARATION/obj.SLICE_INTERLEAVE)]';
        ...
        dcmHead.ImagesInAcquisition = obj.NO_SLICES_DCM;
        dcmHead.SliceLocation = (z-round(obj.NO_SLICES_DCM/2))*(obj.SLICE_SEPARATION/obj.SLICE_INTERLEAVE);
