classdef proudData
    ...
    methods (Access = public)
            ...
            if app.bartDetected_flag
                ...
                while (echo < dimE) && ~app.stopReco_flag
                    ...
                    while (fa < dimF) && ~app.stopReco_flag
                        ...
                        imageReco(:,:,1,1,1,echo,fa,1,1,1,:,1,1,:) = bart(app,picsCommand,k,s);
            ...
            while (echo < dimE) && ~app.stopReco_flag
                ...
                while (fa < dimF) && ~app.stopReco_flag
                    ...
                    while (dynamic < ndimD) && ~app.stopReco_flag
                        ...
                        % Image out
                        imagesOut(:,:,:,dynamic,fa,echo) = reco;
        ...
        function obj = ExportRecoParametersFcn(obj, app, exportdir)
            ...
            sense = num2str(obj.coilSensitivities);
            for i = 1:10
                sense = strrep(sense,"  "," ");
            end
            ...
            pars = strcat(...
                ...
                "denoise = ",num2str(app.DeNoiseCheckBox.Value), "\n", ...
                "denoise window = ",num2str(app.DeNoiseWindowEditField.Value), "\n", ...
                "dering = ",num2str(app.DeRingCheckBox.Value), "\n", ...
                "auto coil sensitivity = ", num2str(app.AutoSensitivityCheckBox.Value), "\n", ...
                "active coils = ",num2str(obj.coilActive_flag), "\n", ...
